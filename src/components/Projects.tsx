...
const projects = [
  {
    ...
    liveLink:"https://unique-shortbread-efc72b.netlify.app/"
  },
  {
    id: 2,
    ...
    liveLink:"https://dorachima.github.io/tripwave/"
  },
  {
    id:3 ,
    ...
    icon: Globe,
    description:
      "A modern agency website designed to showcase services, portfolio work, and company information with a clean and professional user experience.",
    features: [
    ...
    learnings:
      "Improved my skills in responsive web design, visual hierarchy, and creating conversion-focused user interfaces.",
    gradient: "from-primary/20 to-accent/40",
    accentColor: "bg-primary",
    liveLink:"https://dorachima.github.io/novara-agency-website/"
  },
];
